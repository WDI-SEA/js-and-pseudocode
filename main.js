...
//     * Log this fourth variable to the console. Check the console to make sure you're getting the desired res -->


var name = "Jade";
var age = 27;
var address = "123 NW ABC Rd";
...
var age = 27;
var address = "123 NW ABC Rd";
var greeting2 = `Hello My name is ${name}, I am ${age} years old, My address is ${address}.`;
...
var sideOne = 4
var sideTwo = 3
var sideThree = Math.sqrt(Math.pow(sideOne, 2) + Math.pow(sideTwo, 2));
...
var largestNumber = x
var smallestNumber = y
    // 1. draw two numbers
    // 2. draw two numbers from a hat
    // 3. discard the smaller number of the two
    // 4. keep the number that is the largest and discard the smallest number
    // 5. draw an additional number
    // 6. compare numbers and determine the largest number.
    // 7. discard smallest number
    // 8. repeat step 5 until you have run out of numbers to draw from ~16 times

var largestNumber = x
var smallestNumber = y
    // 1. draw two numbers
    // 2. draw two numbers from a hat
    // 3. discard the larger number of the two
    // 4. keep the number that is the smallest and discard the larger number
    // 5. draw an additional number
    // 6. compare numbers and determine the smaller number.
    // 7. discard larger number
    // 8. repeat step 5 until you have run out of numbers to draw from ~16 times
...
// Resources
//     [MDN Reference
//         for the Math object](https: //developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Math)
