...
let greeting = "Hello, my name is " + firstName + ". I'm " + age + " years old and live at " + address
...
let greeting2 = `Hello, my name is ${firstName}. I'm ${age} years old and live at ${address}`
