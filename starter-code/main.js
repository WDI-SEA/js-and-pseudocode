...
var myName = "Emmeline";
var myAge = 30;
var myAddress = "100 Main St";

var greeting = "Hello, my name is " + myName + ". I am this old " + myAge + ". You can find me around " + myAddress;
...
var smallestNumber = y
    // 1. There are 20 random numbers in a hat
    // 2. draw two numbers from a hat
    // 3. keep the number that is the largest and discard the smallest number
    // 4. draw another number from the hat
    // 5. compare numbers and determine the largest number.
    // 6. discard smallest number
    // 7. repeat step 4 until you have run out of numbers to draw from ~16 times
