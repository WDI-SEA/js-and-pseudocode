...
/*
Pseudocode:
 We are given a list of 20 numbers.
 We define a variable called largestNumber and assign the first number in the list as its starting value (so we have a value for comparison)
 Go through the list from the beginning to the end.
  For each number in the list, compare it to largestNumber.
    If the list number is larger than largestNumber, assign the list number to largestNumber.
 The variable largestNumber contains the largest number in the list.

 Variables needed:
  The list of 20 numbers
  a variable named largestNumber, to hold the results of each comparison and our end result

  Bonus:
  The pseudocode would look the same, except we would define a variable named smallestNumber instead of largestNumber. We would compare the list number to see if it is smaller than smallestNumber. If so, we assign list number to smallestNumber.
*/
