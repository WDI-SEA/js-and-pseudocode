...
var greeting = "Hello, I'm " + name + ", I'm " + age + " years old and I live in " + address;
...
var pythag = Math.sqrt(Math.pow(side1, 2) + Math.pow(side2, 2));
console.log(`side one: ${side1}`)
console.log(`side two: ${side2}`)
console.log(`side three: ${pythag}`);
...
/*
1. assign first number in list a variable name 'a'
2. compare next number ,'b' in list to 'a'
3.  for all numbers in list
	if b is larger than 'a'
		b is set to variable 'a'
		return to step 2
