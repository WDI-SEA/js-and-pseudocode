...
*/
Write out list of numbers
Compare first number with second Number
Throw out lower Number
Compare remaining number with next Number
continue until end of list.


For smallest do the same thing but
throw out the higher number instead of the lower Number
